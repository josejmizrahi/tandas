...
/// item 7c — moves the data that previously lived on the `GroupType`
/// enum into `Template`, so a template is the single source of truth for
/// how it shows up in onboarding and elsewhere.
///
