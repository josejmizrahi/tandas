...
enum ModuleRegistry {
    ...
    static let v1Modules: [GroupModule] = [
        .basicFines,
        .rotatingHost,
        .rsvp,
        .checkIn,
    ...
    static let byId: [String: GroupModule] = Dictionary(
    ...
    /// empty if valid.
    static func validate(ids: [String]) -> [ValidationIssue] {
    ...
    enum ValidationIssue: Sendable, Equatable, Hashable {
