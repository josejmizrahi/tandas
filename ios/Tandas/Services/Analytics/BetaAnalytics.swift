...
struct BetaAnalytics: Sendable {
    ...
    func voteCast(voteId: UUID, voteType: String, choice: String) async {
    ...
    func fineAppealStarted(fineId: UUID, ruleSlug: String?) async {
    ...
    func fineSeen(fineId: UUID, ruleSlug: String?, isMine: Bool, status: String) async {
    ...
    func finePaid(fineId: UUID, amountMxn: Int) async {
    ...
    func notificationTapped(kind: String) async {
...
extension AnalyticsEvent {
    ...
    static func voteCast(voteId: UUID, voteType: String, choice: String) -> AnalyticsEvent {
    ...
    static func fineAppealStarted(fineId: UUID, ruleSlug: String?) -> AnalyticsEvent {
    ...
    static func fineSeen(fineId: UUID, ruleSlug: String?, isMine: Bool, status: String) -> AnalyticsEvent {
    ...
    static func finePaid(fineId: UUID, amountMxn: Int) -> AnalyticsEvent {
    ...
    static func notificationTapped(kind: String) -> AnalyticsEvent {
