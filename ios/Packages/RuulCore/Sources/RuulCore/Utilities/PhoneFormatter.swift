...
public enum PhoneFormatter {
    ...
    public static func e164(dialCode: String, rawInput: String) -> String? {
    ...
    public static func smartE164(_ raw: String, defaultDialCode: String = "52") -> String? {
    ...
    public static func displayFormat(_ e164: String) -> String {
