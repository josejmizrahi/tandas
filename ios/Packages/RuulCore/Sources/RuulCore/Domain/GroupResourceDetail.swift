...
public extension GroupResourceDetail {
    ...
    /// Lazily decode the space subtype payload.
    var spaceSubtype: SpaceSubtypeData? {
    ...
    /// Lazily decode the slot subtype payload.
    var slotSubtype: SlotSubtypeData? {
        decodedSubtype(expected: .slot)
    }
