...
public final class CalendarExportService {
    ...
    public func addToCalendar(_ event: Event, vocabulary: String) async throws -> String {
    ...
    public func icsFileURL(for event: Event, vocabulary: String, hostName: String?) throws -> URL {
