...
public protocol WalletPassGenerator: Sendable {
...
public final class StubWalletPassGenerator: WalletPassGenerator {
    private let log = Logger(subsystem: "com.josejmizrahi.ruul", category: "wallet")

    public init() {}

    public func createPass(forEventId eventId: UUID, memberId: UUID) async -> URL? {
