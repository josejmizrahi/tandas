...
public enum QRSignatureService {
    /// Build a signed payload string for an event + member.
    public static func sign(eventId: UUID, memberId: UUID, secret: String) -> String {
    ...
    public static func verify(_ payload: String, secret: String) -> (eventId: UUID, memberId: UUID)? {
