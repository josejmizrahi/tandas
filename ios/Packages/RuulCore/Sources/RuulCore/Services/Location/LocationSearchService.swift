...
public final class LocationSearchService: NSObject {
    ...
    public private(set) var suggestions: [MKLocalSearchCompletion] = []
    ...
    public func resolve(_ suggestion: MKLocalSearchCompletion) async -> (name: String, lat: Double, lng: Double)? {
