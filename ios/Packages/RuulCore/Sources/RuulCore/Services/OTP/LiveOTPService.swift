...
public final class LiveOTPService: OTPService {
    ...
    public func requestCode(phoneE164: String) async throws -> OTPChannel {
    ...
    public func verifyCode(phoneE164: String, code: String, channel: OTPChannel) async throws {
        switch channel {
        case .whatsapp:
...
public final class MockOTPService: OTPService, @unchecked Sendable {
    public var requestResult: Result<OTPChannel, OTPError> = .success(.whatsapp)
    public var verifyResult: Result<Void, OTPError> = .success(())
    public private(set) var requestCalls: [String] = []
    public private(set) var verifyCalls: [(String, String, OTPChannel)] = []
