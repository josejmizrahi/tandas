...
public enum AnalyticsEvent: Sendable {
    ...
    public enum FlowKind: String, Sendable { case founder, invited }
...
public final class LogAnalyticsService: AnalyticsService {
    ...
    public func setUser(_ userId: UUID, properties: [String: AnalyticsValue]) async {
        log.debug("setUser \(userId) \(String(describing: properties))")
    }
}

/// Mock for tests.
public actor MockAnalyticsService: AnalyticsService {
