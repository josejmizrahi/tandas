...
public enum DefaultIntents {
    ...
    public static let trackMoney = ResourceIntent(
        ...
        requiredCapabilities: ["ledger", "money"],
    ...
    public static let recordValuation = ResourceIntent(
        ...
        requiredCapabilities: ["valuation"],
