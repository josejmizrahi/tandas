...
public struct AppealVoteCounts: Sendable, Hashable, Codable {
    ...
    public init(inFavor: Int, against: Int, abstained: Int, pending: Int, totalEligible: Int) {
...
public struct AppealVote: Identifiable, Sendable, Hashable, Codable {
    ...
    public init(id: UUID, appealId: UUID, memberId: UUID, choice: AppealVoteChoice, votedAt: Date?, createdAt: Date, updatedAt: Date) {
        self.id = id
