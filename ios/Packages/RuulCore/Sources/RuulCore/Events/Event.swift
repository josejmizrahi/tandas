...
public struct Event: Identifiable, Codable, Sendable, Hashable {
    ...
    public let applyRules: Bool
    public let status: EventStatus
    public let cancellationReason: String?
    public let isRecurringGenerated: Bool
    public let parentEventId: UUID?
    public let cycleNumber: Int?
    public let rsvpDeadline: Date?
...
public extension Event {
    ...
    public var resolvedEndsAt: Date {
    ...
    public var coverDisplayName: String {
