...
public struct EventHostActionsSection: View {
    public let event: Event
    public let group: RuulCore.Group
    public let totalConfirmed: Int
    public let totalMembers: Int
    public let onSendReminders: () -> Void
    public let onEdit: () -> Void
    public let onOpenScanner: () -> Void
    public let onCancelEvent: () -> Void
    public let onCloseEvent: () -> Void
    public let onToggleAutoGenerate: (Bool) -> Void
    public let canIssueManualFine: Bool
    public let onIssueManualFine: () -> Void

    public init(event: Event, group: RuulCore.Group, totalConfirmed: Int, totalMembers: Int, onSendReminders: @escaping () -> Void, onEdit: @escaping () -> Void, onOpenScanner: @escaping () -> Void, onCancelEvent: @escaping () -> Void, onCloseEvent: @escaping () -> Void, onToggleAutoGenerate: @escaping (Bool) -> Void, canIssueManualFine: Bool, onIssueManualFine: @escaping () -> Void) {
        self.event = event
        self.group = group
        self.totalConfirmed = totalConfirmed
        self.totalMembers = totalMembers
        self.onSendReminders = onSendReminders
        self.onEdit = onEdit
        self.onOpenScanner = onOpenScanner
        self.onCancelEvent = onCancelEvent
        self.onCloseEvent = onCloseEvent
        self.onToggleAutoGenerate = onToggleAutoGenerate
        self.canIssueManualFine = canIssueManualFine
        self.onIssueManualFine = onIssueManualFine
    }
