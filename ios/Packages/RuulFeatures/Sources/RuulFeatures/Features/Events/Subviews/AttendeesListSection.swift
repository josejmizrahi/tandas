...
public struct AttendeesListSection: View {
    ...
    public var onSelectAttendee: ((UUID) -> Void)? = nil

    public init(rsvps: [RSVP], memberLookup: @escaping (UUID) -> (name: String, avatarURL: URL?), onSelectAttendee: ((UUID) -> Void)? = nil) {
        self.rsvps = rsvps
        self.memberLookup = memberLookup
        self.onSelectAttendee = onSelectAttendee
    }
