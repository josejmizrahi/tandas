...
public final class CheckInScannerCoordinator {
    ...
    public private(set) var overlay: Overlay = .none
    public private(set) var recentCheckIns: [(memberId: UUID, name: String, at: Date)] = []
    public private(set) var checkedCount: Int = 0
    public let totalConfirmed: Int

    public let event: Event
    public let scanner: QRScannerService
    ...
    public func handleScan(_ payload: String) async {
