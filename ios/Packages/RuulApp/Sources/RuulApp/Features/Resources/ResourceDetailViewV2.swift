...
public struct ResourceDetailViewV2: View {
    ...
    //
    // Slice 7.A.5 (audit 2026-06-14) — copy conversacional: cero jerga
    // `right USE`, `right OWN`, `actor`, `rules`, `lifecycle`, `settlement
    // batches`. Lo que ve el usuario es lo que el recurso puede hacer en
    // lenguaje humano, no la columna del catálogo backend.
