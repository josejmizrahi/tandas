...
--
-- Drifts capturados:
--   - subject_kind whitelist: sanction | rule | resource | member | other (no 'general').
--   - resolution_method whitelist: conversation | mediation | vote | admin_decision
--     | arbitration | separation | other (no 'mediated').
