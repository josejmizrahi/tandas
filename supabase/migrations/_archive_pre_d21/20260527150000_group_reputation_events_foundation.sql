-- 20260527150000 — group_reputation_events feed (Primitiva 12 — C4).
--
-- record_reputation_event y member_reputation_events ya existen
-- canónicos. Lo que falta para C4 es una superficie de lectura
-- group-wide: feed cronológico cruzando todos los miembros, pre-joined
-- con subject + actor display names (member feed no necesitaba
-- esto porque el contexto ya tenía al miembro).
--
-- Mantiene la doctrina de Primitiva 12: NO score, NO ranking, NO
-- badges. Sólo hechos neutrales en orden cronológico.
