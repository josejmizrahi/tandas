-- R.2Q.1 — Permitir abstain sin option en single_choice (compat con R.2G smoke).
-- En el modelo de votación con opciones, abstain significa "no voto por nadie";
-- exigir option para abstain rompía el caso donde un miembro se quiere mantener al margen.
