...
comment on function public.resolve_governance(uuid, uuid, text, jsonb) is
  'v2 (mig 00238): rule.% fallback for whoCanModifyRules=founder now consults has_permission(modifyRules) instead of comparing actor to created_by. Aligns with member.remove and member.invite fallbacks.';
