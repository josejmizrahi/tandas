...
BEGIN
  ...
  -- B5.5: release on empty fails 22023.
  BEGIN
  ...
  -- B5.6: premature expire blocked (no slot_ends_at).
  BEGIN
  ...
  -- B5.7: set ends in past + expire happy.
