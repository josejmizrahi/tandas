...
--
-- Context: mig 00263 was originally written before main's mig 00262
-- introduced the admin role. The earlier version of mig 00263 is
...
-- for existing groups:
--   1. founder.permissions — groups created BETWEEN mig 00263's first
...
-- apply mig 00263 (the rewritten version) and never need this mig;
-- running it anyway is safe.

BEGIN;

-- ============================================================
-- Founder backfill (covers groups born between mig 00263 + 00262)
-- ============================================================
...
begin
  ...
  raise notice 'mig 00269: %/% groups grant founder.expenseSubmit; %/% groups grant admin.expenseSubmit',
