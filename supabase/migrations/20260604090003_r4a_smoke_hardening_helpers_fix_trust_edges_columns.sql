...
begin
  ...
  -- C1: trust_edges updated_at trigger
  ...
  if v_te_new is null or v_te_new <= v_te_orig then
    raise exception 'r4a C1: trust_edges updated_at trigger did not fire (orig=% new=%)',
      v_te_orig, v_te_new;
  end if;
