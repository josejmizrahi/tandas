-- ============================================================================
-- R.5A.B.6 fixup: resource_available_actions returns jsonb (array), not SETOF.
-- Iterar con jsonb_array_elements en vez de from CTE.
-- ============================================================================
...
begin
  ...
  -- Actions: resource_available_actions returns jsonb array; iterar elements
  ...
  -- action_forms (map keyed por action_key, sólo para acciones disponibles)
  ...
  return jsonb_build_object(
    ...
    'linked_events', '[]'::jsonb, 'linked_documents', v_linked_documents,
    'linked_obligations', '[]'::jsonb, 'linked_decisions', '[]'::jsonb,
