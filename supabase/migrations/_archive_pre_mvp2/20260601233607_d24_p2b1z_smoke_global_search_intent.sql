-- d24_p2b1z_smoke_global_search_intent
...
-- D.24 P2B-1.z — _smoke_global_search ahora setea intent_marker
-- explícito antes de cada INSERT directo a la compat view group_resources.
-- Evita que aparezca como 'legacy_view_write' en audit.
...
BEGIN
  ...
  -- P2B-1.z: intent_marker explícito para que la compat trigger no marque legacy_view_write.
  PERFORM set_config('ruul.resource_create_intent', '_smoke_global_search', true);
