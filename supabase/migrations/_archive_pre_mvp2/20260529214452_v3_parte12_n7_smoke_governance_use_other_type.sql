-- PARTE 12 — N.7 fix2: decision_type 'free_form' no existe en CHECK constraint.
-- Allowed: proposal, poll, election, budget, rule_change, membership, sanction_appeal,
-- mandate_grant, mandate_revoke, dissolution, other. Uso 'other' (sin handler en finalize_vote).
