-- PARTE 12 — N.7 fix4: cast_vote(4-arg) y cast_vote(5-arg con p_weight DEFAULT NULL)
-- son ambiguos para PG porque el 5-arg matchea cualquier llamada de 4 args.
-- Llamo explícito el 5-arg con weight=1. (Drop del 4-arg legacy = mig separada.)
