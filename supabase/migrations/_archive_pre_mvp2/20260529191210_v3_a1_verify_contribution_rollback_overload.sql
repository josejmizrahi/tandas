-- 20260530000100 — Rollback del overload erróneo creado en 20260530000000.
--
...
--
-- Esta mig elimina el overload 3-arg (uuid, uuid, text) que aterricé sin saber
-- de la implementación previa. La firma canónica vigente es:
