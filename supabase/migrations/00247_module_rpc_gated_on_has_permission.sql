-- 00236 — set_group_module gated on has_permission.
    ...
    jsonb_build_object(
      'founder', jsonb_build_object(
        ...
        'permissions', jsonb_build_array(
          ...
          'createVotes','manageEvents','manageModules'
        )
      ),
...
comment on function public.set_group_module(uuid, text, boolean) is
  'v3 (mig 00236): auth gate is has_permission(manageModules) instead of is_group_admin. Enables custom roles to control module activation without admin promotion.';
