-- ============================================================================
-- AUDIT.5 — Smoke: baseline estructural de seguridad e higiene (2026-06-11)
-- ============================================================================
-- Vuelve invariantes de CI los hallazgos cerrados por audit_1..audit_4
-- (Plans/Active/SupabaseTargetArchitecture.md §10). Corre con el resto de la
-- suite _smoke_mvp2_* en edge-tests.yml; cualquier regresión estructural
-- (tabla sin RLS, función sin search_path, actividad sin catalogar, etc.)
-- tumba el job.
-- ============================================================================
...
comment on function public._smoke_mvp2_audit_baseline() is
  'AUDIT.5: invariantes estructurales (RLS total, anon=0, search_path pineado, touch triggers, actividad catalogada, índices hot). Ver Plans/Active/SupabaseTargetArchitecture.md §10.';
