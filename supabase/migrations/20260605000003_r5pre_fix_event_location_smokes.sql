-- ============================================================================
-- R.5-PRE · Repair pre-existing MVP2 smokes broken by F.EVENT.5 (location required)
-- ============================================================================
-- Estos smokes (era MVP2) se escribieron antes de F.EVENT.5 y creaban eventos
-- sin ubicacion, por lo que create_calendar_event los rechaza
-- ("location_required: events must have a location unless marked as virtual").
-- Aqui se re-crean con una ubicacion ('Por definir') en cada create_calendar_event.
--
-- Es deuda pre-existente de main (edge-tests llevaba 8 pushes en rojo), no de R.5.
-- Solo se arregla el subconjunto resuelto en esta tanda (clase "location").
-- Pendiente en tarea aparte: smokes con overloads droppeados
-- (request_resource_reservation, create_decision) y shape r2s.
--
-- CREATE OR REPLACE preserva los grants de las migraciones originales.
-- ============================================================================
