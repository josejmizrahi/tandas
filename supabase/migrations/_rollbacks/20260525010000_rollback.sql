-- Rollback for 20260525010000_fix_create_group_with_admin_role_column.sql.
--
-- Restores the broken pre-fix body (with the dead `role` column in the
-- group_members INSERT). Applying this rollback re-breaks group
-- creation — only useful for migration-replay testing.
