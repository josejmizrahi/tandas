...
-- mig 00246) and bump_rule_version (v4, mig 00247); drop the validator
-- + compile helpers. Per migrations/_rollbacks/README.md this is
-- dev/staging only — production should fix-forward.
--
...
-- 1. Restore publish_rule_composition v5 (mig 00246, slug-aware).
...
-- 2. Restore bump_rule_version v4 (mig 00247, membership-aware).
