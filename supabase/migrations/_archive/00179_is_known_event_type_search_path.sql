-- Mig 00179: Lock down search_path on is_known_system_event_type.
--
-- Supabase advisor flagged the immutable whitelist as having a mutable
-- search_path. Adding `set search_path = pg_catalog` qualifies the
-- function explicitly. Body unchanged.
