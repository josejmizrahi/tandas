...
-- pre-joined: estado actual + display names + subject context. Excluye
-- estados terminales (resolved/dismissed/closed) para que la card en
-- GroupHome muestre solo lo que necesita atención.
