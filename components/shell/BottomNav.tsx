...
export default function BottomNav({ groupId }: { groupId: string }) {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-30 bg-background/70 backdrop-blur-xl supports-[backdrop-filter]:bg-background/60 border-t pb-[env(safe-area-inset-bottom)]">
